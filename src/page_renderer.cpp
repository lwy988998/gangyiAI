...
<main class="min-h-screen bg-[radial-gradient(circle_at_top,rgba(219,234,254,0.9),rgba(248,251,255,0.98)_44%,rgba(255,255,255,1))] text-slate-950">
  <section class="mx-auto flex min-h-[calc(100vh-3.25rem)] w-full max-w-6xl flex-col items-center px-4 pb-10 pt-5 text-center sm:px-6 sm:pt-8">
    <img src="/school-logo.png" alt="柳州市钢一中学校徽" class="object-contain" style="width:180px;height:180px"><p class="mt-4 text-xs font-semibold uppercase tracking-[0.14em] text-sky-700">柳州市钢一中学</p><h1 class="mt-2 max-w-3xl text-2xl font-bold tracking-tight text-sky-700 sm:text-4xl">柳州市钢一中学2629班定制AI</h1><p class="mt-2 max-w-xl text-sm leading-6 text-slate-600 sm:text-base">把学习目标变成可以一步步完成的课程。</p>
    <form id="goal-form" class="mt-5 w-full max-w-3xl rounded-2xl border border-slate-200 bg-white p-2 text-left shadow-lg shadow-sky-900/10" action="/plan" method="get"><input id="goal-image" type="file" accept="image/*" class="hidden"><input id="goal-mode" type="hidden" name="mode" value="deep">
